        ...
        <div className="flex items-center justify-between">
          ...
          >
            <ResponsiveImage
              ...
              className="absolute left-[-26px] sm:left-[-10px] md:left-0 top-1/2 -translate-y-1/2 h-[165px] sm:h-[180px] md:h-[280px] max-w-none w-auto transition-all duration-300 group-hover:scale-[1.03] pointer-events-none"
              eager
              width={280}
              height={120}
            />
